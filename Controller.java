...
public class Controller {
    ...
    public static int repFactor;
    public static int timeout;
    public static int reb_period;
                        ...
                        try {
                            ...
                            while ((line = inStr.readLine()) != null) {
                                if (isRebalancing.get() == false) {
                                    handleCommands(line, DstoreObj, client, out, reloadCount, queue);
                                } else {
                                    queue.add(line);
                                }
                            }
    ...
    private static void handleCommands(String line, DstoreObject DstoreObj, Socket client, PrintWriter out, int reloadCount, ConcurrentLinkedQueue<String> queue) throws Exception {
